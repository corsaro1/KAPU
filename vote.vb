...
fooerror:
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        ' votepools = "no"
        If MsgBox("Completing this procedure will cost you 1 KAPU and you will vote ", MsgBoxStyle.OkCancel, "Title") = MsgBoxResult.Ok Then
...
fooerror:
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        ' votepools = "no"
        If MsgBox("Completing this procedure will cost you 1 KAPU and you will unvote ", MsgBoxStyle.OkCancel, "Title") = MsgBoxResult.Ok Then
