...
Public Class Lisk
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        pRegKey = pRegKey.OpenSubKey("SOFTWARE\kapu")
    ...
    Private Sub carica()
        ...
        Dim reader As StreamReader
        On Error Resume Next
        request = DirectCast(WebRequest.Create("https://walletapi.kapu.one/api/accounts?address=" & senderId), HttpWebRequest)
        response = DirectCast(request.GetResponse(), HttpWebResponse)
        reader = New StreamReader(response.GetResponseStream())
    ...
    Private Sub Button2_Click_2(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        Dim url As String = "https://walletapi.kapu.one/api/transactions"

        If RadioButton1.Checked = True Then
            url = "https://walletapi.kapu.one/api/transactions"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:9700/api/transactions"
        ...
        Try
            ...
            If Regex.IsMatch(original, "^[0-9 ]+$") Then
                If post = "" Then
                    ...
                    MsgBox(original & ",00" & " KAPU will be sent")

                Else

                    MsgBox(original & "," & post & " KAPU will be sent")
...
FooError:
    ...
    Private Sub Button4_Click(sender As System.Object, e As System.EventArgs) Handles Button4.Click
        ...
        Dim newkey As RegistryKey = key.CreateSubKey("kapu")
...
fooerror:
    ...
    Private Sub Button6_Click(sender As System.Object, e As System.EventArgs) Handles Button6.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        votepools = "no"
        If MsgBox("Completing this procedure will cost you 1 KAPU and you will vote all public wallet delegates: corsaro, phoenix1969, vipertdk, punkrock, hagie, gr33ndragon, bioly and isabella, so to support this software", MsgBoxStyle.OkCancel, "Title") = MsgBoxResult.Ok Then
...
fooerror:
    ...
    Private Sub Button8_Click(sender As System.Object, e As System.EventArgs) Handles Button8.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        Dim url As String = "https://walletapi.kapu.one/api/accounts/delegates"

        If RadioButton1.Checked = True Then
            url = "https://walletapi.kapu.one/api/accounts/delegates"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:9700/api/accounts/delegates"
        ...
        request = DirectCast(WebRequest.Create("https://walletapi.kapu.one/api/accounts/delegates/?address=" & senderId), HttpWebRequest)
        response = DirectCast(request.GetResponse(), HttpWebResponse)
        reader = New StreamReader(response.GetResponseStream())
...
FooError:
    ...
    Private Sub Button13_Click(sender As System.Object, e As System.EventArgs) Handles Button13.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        If MsgBox("Completing this procedure will cost you 1 KAPU and you will vote all public wallet delegates: corsaro, phoenix1969, vipertdk, punkrock, hagie, gr33ndragon, bioly and isabella, so to support this software and besides you will stake your lisk on some of the main Lisk pools:" & vbCrLf & vbCrLf & "phinx" & vbCrLf & "shinekami" & vbCrLf & "thepool" & vbCrLf & "liskpool_com_01" & vbCrLf & "robinhood" & vbCrLf & "rooney" & vbCrLf & "badman0316" & vbCrLf & "lisk.pool.sexy", MsgBoxStyle.OkCancel, "Title") = MsgBoxResult.Ok Then
...
fooerror:
    ...
    Private Sub Button15_Click(sender As System.Object, e As System.EventArgs) Handles Button15.Click
        ...
        Dim url As String = "https://walletapi.kapu.one/api/accounts/generatePublicKey"
...
fooerror:
    ...
    Private Sub BackgroundWorker1_DoWork_1(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        request = DirectCast(WebRequest.Create("https://walletapi.kapu.one/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker3_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker3.DoWork
        ...
        request3 = DirectCast(WebRequest.Create("http://127.0.0.1:9700/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub Button17_Click(sender As System.Object, e As System.EventArgs) Handles Button17.Click
        ...
        Dim url As String = "https://walletapi.kapu.one/api/multisignatures/sign"

        If RadioButton1.Checked = True Then
            url = "https://walletapi.kapu.one/api/multisignatures/sign"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:9700/api/multisignatures/sign"
...
Fooerror2:
    ...
    Private Sub Button21_Click(sender As System.Object, e As System.EventArgs) Handles Button21.Click
        ...
        ElseIf result = DialogResult.OK Then
            ...
            'request = DirectCast(WebRequest.Create("https://walletapi.kapu.one/api/accounts?address=" & senderid2), HttpWebRequest)
        End If
...
fooerror:
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        '  Dim url As String = "https://walletapi.kapu.one/api/accounts/generatePublicKey"
        '  Dim url As String = "https://walletapi.kapu.one/api/accounts/open"
        '  Dim url As String = url1 + "api/accounts/open"


        Dim url As String = "https://walletapi.kapu.one/api/delegates"

        If RadioButton1.Checked = True Then
            url = "https://walletapi.kapu.one/api/accounts/open"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:9700/api/accounts/open"
        ...
        Else
            MsgBox("Secret has been saved on your PC. Kindly make different copies of this file to not lost your KAPU in case of hdd failure")
        End If
...
fooerror:
    ...
    Private Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        If MsgBox("With this procedure you will associate a delegate name to your address and will cost 25 KAPU", MsgBoxStyle.OkCancel, "Title") = MsgBoxResult.Ok Then
...
fooerror:
    ...
    Private Sub Button27_Click(sender As Object, e As EventArgs) Handles Button27.Click
        ...
        If RadioButton1.Checked = True Then
            url = "https://walletapi.kapu.one/api/delegates"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:9700/api/delegates"
