...
Public Class newAddress
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        Dim xml As String = "{" & Chr(34) & "secret" & Chr(34) & ":" & Chr(34) & seed & Chr(34) & "," & Chr(34) & "amount" & Chr(34) & ":" & "1" & "," & Chr(34) & "recipientId" & Chr(34) & ":" & Chr(34) & "KDn3WyMCHzfhtpzaiUmb4GJLyFPrcaF5Kn" & Chr(34) & "}"
...
fooerror:
    ...
    Private Sub pubkey()
        ...
        Dim url1 As String = "https://walletapi.kapu.one/"
